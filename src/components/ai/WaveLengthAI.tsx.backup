  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: '1',
      type: 'ai',
      content: "Hello! I'm WaveLength AI, your intelligent assistant. I can help you with inventory management, employee tracking, fraud detection, and much more. I can also read what's on your screen and provide insights!",
      timestamp: new Date(),
      suggestions: [
